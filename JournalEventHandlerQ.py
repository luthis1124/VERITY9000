...
class JournalEventHandlerQ:
        ...
        try:
            while not self.shutdown_event.is_set():
                if self.shared["first_run"]:
                    try:
                        init_request = self.to_ev_initial.get(timeout=10)
                        if init_request:
    ...
    def handle_event(self, data: dict):
        ...
        {"timestamp": "2026-06-26T04:16:17Z", "event": "SupercruiseExit", "Taxi": false, "Multicrew": false,
         "StarSystem": "Eleu", "SystemAddress": 2557686616810, "Body": "Finney Dock", "BodyID": 29,
         "BodyType": "Station"}

        {"timestamp": "2026-06-26T04:21:04Z", "event": "SupercruiseEntry", "Taxi": false, "Multicrew": false,
         "StarSystem": "Eleu", "SystemAddress": 2557686616810}
        """
